...
const names=new Set(['function.reuse','function.execute','workflow.run','image.generate','wake.state','voice.session','voice.startup','voice.delegation','voice.tool','voice.timer_fast','voice.close','agent.decision','agent.planning','agent.cleanup','agent.recovery']);
